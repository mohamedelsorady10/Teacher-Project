...
namespace PresentationLayerPL
{
    public partial class GroupsFrm : Form
    {
       ...
       GroupsOperationBL groupsConn = new GroupsOperationBL(ConfigurationManager.ConnectionStrings["TeacherDBEntities"].ConnectionString);
        ...
        {
            Enabling();
            txtGroupLocation.Text = txtGroupName.Text = string.Empty;
        }
        private void Enabling()
        {
            txtGroupLocation.Enabled = txtGroupName.Enabled = true; 
        }
        private void Clear()
        {
            txtGroupName.Text = txtGroupLocation.Text = string.Empty;
        ...
        {
            if (!string.IsNullOrEmpty(txtGroupLocation.Text) && !string.IsNullOrEmpty(txtGroupName.Text))
            {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtGroupName.Text) || string.IsNullOrEmpty(txtGroupLocation.Text))
            {
