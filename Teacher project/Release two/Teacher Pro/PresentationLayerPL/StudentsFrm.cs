...
namespace PresentationLayerPL
{
    public partial class StudentsFrm : Form
    {
        ...
        {
            dgvStudents.DataSource = studentsConn.ReadAllDGV();
        ...
        {
            if (!string.IsNullOrEmpty(txtAddress.Text) && !string.IsNullOrEmpty(txtNotes.Text) && !string.IsNullOrEmpty(txtParentMobile.Text) && !string.IsNullOrEmpty(txtStudentMobile.Text) && !string.IsNullOrEmpty(txtStudentName.Text) && cmbGroups.SelectedValue != null && Regex.IsMatch(txtStudentMobile.Text, "^01(0|1|2)\\d{8}$") == true && Regex.IsMatch(txtParentMobile.Text, "^01(0|1|2)\\d{8}$") == true)
            {
        ...
        private void txtStudentMobile_Leave(object sender, EventArgs e)
        {
            string pattern = "^01(0|1|2)\\d{8}$";
            if (Regex.IsMatch(txtStudentMobile.Text, pattern)) { errorProvider1.Clear(); }

            else { errorProvider1.SetError(this.txtStudentMobile, "Plz provide valid Phone Number"); return; }
        }

        private void txtParentMobile_Leave(object sender, EventArgs e)
        {
            string pattern = "^01(0|1|2)\\d{8}$";
            if (Regex.IsMatch(txtParentMobile.Text, pattern)) { errorProvider1.Clear(); }

            else { errorProvider1.SetError(this.txtParentMobile, "Plz provide valid Phone Number"); return; }
        }
        ...
        private void txtAddress_Leave(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(txtAddress, "Plz enter an Address");
            }
        ...
        private void txtStudentName_Leave(object sender, EventArgs e)
        {
            ...
            {
                errorProvider1.SetError(txtStudentName, "Plz enter a Name");
            }
            else { errorProvider1.Clear(); }
        }
    }
